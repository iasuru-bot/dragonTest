...
describe('Dungeon', () => {
    ...
    beforeEach(() => {
        heroes = [
            new hero_1.Hero('Hero1', 100, 15, 200, "Male"), // Create first hero
            new hero_1.Hero('Hero2', 100, 20, 150, "Male"), // Create second hero
        ];
        dragon = new dragon_1.Dragon('Fierce Dragon', 50, 3, 10); // Create a dragon instance
        dungeon = new dungeon_1.Dungeon(heroes, dragon); // Initialize the Dungeon instance
    });
    //   /**
